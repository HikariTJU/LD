...
model = dict(
    ...
    output_feature=True,
    teacher_config='configs/imv2/gflv2_r2n101_dcn_fpn_2x.py',
    teacher_ckpt='gfocal_r2n101_dcn_fpn_ms2x-b38c00b0.pth',  # noqa
    backbone=dict(
        type='ResNeXt',
        depth=101,
        groups=32,
    ...
    bbox_head=dict(
        ...
        loss_im=dict(type='IMLoss', loss_weight=1.0),
