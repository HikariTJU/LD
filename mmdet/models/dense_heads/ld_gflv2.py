...
class LDv2Head(GFocalHead):
    ...
    def loss_single(self, anchors, cls_score, cls_feat, bbox_pred, labels, label_weights,
    ...
    def get_gi_region(self, soft_label, cls_score, anchors, bbox_pred,
        ...
        teacher_score = soft_label.detach()

        student_score = cls_score.detach()  #[num,80]
