...
class IMHead(GFLHead):
    ...
    def __init__(self,
                 ...
                 loss_kd=dict(
                     ...
                     T=10),
                 **kwargs):
        super(IMHead, self).__init__(num_classes, in_channels, **kwargs)
    ...
    def loss_single(self, anchors, cls_score, bbox_pred, labels, label_weights,
        ...
        fg_inds = (assigned_neg > 0).nonzero().squeeze(1)
        if len(fg_inds) > 0:
        ...
        return loss_cls, loss_bbox, loss_dfl, loss_ld, loss_ld_neg, loss_cls_kd, loss_im, loss_gibox_im, weight_targets.sum(
        )
    ...
    def loss(self,
        ...
        losses_cls, losses_bbox, losses_dfl, losses_ld, losses_ld_neg, losses_cls_kd, losses_im, losses_gibox_im,\
