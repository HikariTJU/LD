...
class LDRPNHead(RPNGFLHead):
    ...
    def _get_targets_single(self,
        ...
        assigned_neg = self.assign_neg(anchors, num_level_anchors_inside,
                                       gt_bboxes)
    ...
    def assign_neg(
        ...
        diou = self.iou_calculator(bboxes, gt_bboxes, mode='iou')
        # assign 0 by default
